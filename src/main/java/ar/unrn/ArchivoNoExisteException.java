...
public class ArchivoNoExisteException extends ArchivoException {
    /**
     ...
     */
    public ArchivoNoExisteException(Throwable razon) {
        super(razon);
    }
     ...
     */
    public ArchivoNoExisteException(String mensaje, Throwable razon) {
        super(mensaje, razon);
    }
